      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start mb-20">
          ...
          <div ref={rightRef} className="lg:col-span-5 grid grid-cols-2 gap-4">
            <div className="border border-thrift-border p-6 flex flex-col justify-between h-52 sm:h-60 bg-[#f5f0e8]">
            ...
            <div className="border border-thrift-border p-6 flex flex-col justify-between h-52 sm:h-60 bg-[#f5f0e8] sm:mt-8">
