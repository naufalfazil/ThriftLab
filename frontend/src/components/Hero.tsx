...
export default function Hero({ ready = true }: HeroProps) {
  ...
  return (
    ...
    >
      <div
        ref={glowRef}
        className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-[#ff3b00]/5 rounded-full blur-[120px] pointer-events-none"
      />
      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center relative z-10">
        <div className="lg:col-span-9 flex flex-col items-start">
          ...
          <p
            ref={descRef}
            className="text-base sm:text-lg text-[#888] max-w-lg leading-relaxed mb-10 font-light opacity-0"
          >
